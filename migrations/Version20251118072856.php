 ...
 */
final class Version20251118072856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD COLUMN competences CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE utilisateur ADD COLUMN updated_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE utilisateur_competence (utilisateur_id INTEGER NOT NULL, competence_id INTEGER NOT NULL, PRIMARY KEY(utilisateur_id, competence_id), CONSTRAINT FK_A66CAA69FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A66CAA6915761DAB FOREIGN KEY (competence_id) REFERENCES competence (id) ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__utilisateur AS SELECT id, role_id, manager_id, nom, prenom, email, adresse, titre_poste, departement, equipe, message, password, matricule, est_actif, capacite_hebdo_h, photo_profil, date_creation FROM utilisateur');
