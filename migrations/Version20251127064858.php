 ...
 */
final class Version20251127064858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, projet_id INTEGER NOT NULL, performed_by_id INTEGER DEFAULT NULL, "action" VARCHAR(50) NOT NULL, remarks CLOB DEFAULT NULL, old_status VARCHAR(50) DEFAULT NULL, new_status VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , CONSTRAINT FK_B1A47C2EC18272 FOREIGN KEY (projet_id) REFERENCES projet (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B1A47C2E2E65C292 FOREIGN KEY (performed_by_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_B1A47C2EC18272 ON project_history (projet_id)');
        $this->addSql('CREATE INDEX IDX_B1A47C2E2E65C292 ON project_history (performed_by_id)');
        $this->addSql('ALTER TABLE projet ADD COLUMN revision_requests CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE projet ADD COLUMN revision_count INTEGER DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        , raison_refus CLOB DEFAULT NULL, charter_step INTEGER DEFAULT NULL, business_case_data CLOB DEFAULT NULL --(DC2Type:json)
