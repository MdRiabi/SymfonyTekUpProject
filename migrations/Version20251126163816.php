 ...
 */
final class Version20251126163816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD COLUMN charter_step INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE projet ADD COLUMN business_case_data CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE projet ADD COLUMN scope_definition_data CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE projet ADD COLUMN resource_planning_data CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE projet ADD COLUMN go_no_go_data CLOB DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__projet AS SELECT id, responsable_id, client_id, approuve_par_id, nom, description, date_debut, date_fin, type, categorie, objectifs, fonctionnalites, budget, priorite, statut, notes, date_creation, date_modification, date_approbation, raison_refus, fichier_joint FROM projet');
        ...
        , raison_refus CLOB DEFAULT NULL, fichier_joint VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_50159CA953C59D72 FOREIGN KEY (responsable_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_50159CA919EB6921 FOREIGN KEY (client_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_50159CA95ED9CBB3 FOREIGN KEY (approuve_par_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO projet (id, responsable_id, client_id, approuve_par_id, nom, description, date_debut, date_fin, type, categorie, objectifs, fonctionnalites, budget, priorite, statut, notes, date_creation, date_modification, date_approbation, raison_refus, fichier_joint) SELECT id, responsable_id, client_id, approuve_par_id, nom, description, date_debut, date_fin, type, categorie, objectifs, fonctionnalites, budget, priorite, statut, notes, date_creation, date_modification, date_approbation, raison_refus, fichier_joint FROM __temp__projet');
